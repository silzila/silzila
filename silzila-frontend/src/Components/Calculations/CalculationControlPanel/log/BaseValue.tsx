...
import { addSourceInfoInCalculationFlow, updateDecimalSourceValue } from '../../../../redux/Calculations/CalculationsActions';
...
const BaseValue = ({
    ...
    const [sourceCardHoverActive, setSourceCardHoverActive] = React.useState(false);
    ...
    const debouncedSetInputValue = useCallback(debounce(({
        ...
        updateDecimalSourceValue(propKey, allSourcesInFlowArray.length === 0 ? 0 : 1, value)
    ...
    return (
        <div style={{ height: "50%", padding: "10px" }}>
            <span style={{ fontWeight: 'bold', color: 'gray', textAlign: 'start', display: 'flex', gap: '10px', justifyContent: "space-between" }}>Base value</span>
            <div
