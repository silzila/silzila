...
const SimplecardConditionalFormatting = ({
  ...
  var valueName: any;
  var dataValue: any;
  if (chartControls.properties[propKey]?.chartData[0]) {
    valueName = Object.keys(chartControls.properties[propKey]?.chartData[0]);
    if (valueName)
      dataValue = chartControls.properties[propKey]?.chartData[0][valueName];
  }
  ...
  return (
    <div className="optionsInfo">
      <div
        ...
        style={{ display: "flex", flexDirection: "column", marginTop: "0px", paddingLeft: "0.2rem", paddingRight: "0.3rem" }}
      >
        <div style={{ display: "flex", flexDirection: "column", width: "100%", padding: "0.2rem" }}>
                    ...
                    <div style={{ display: "flex", marginTop: "5px" }}>
                      ...
                      <span className="deleteIconContainer">
                        <DeleteOutlineOutlinedIcon
                          sx={{ fontSize: "16px" }}
                          onClick={() => {
                            const filterdArray = cfList.filter((el: any) => {
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(SimplecardConditionalFormatting);
