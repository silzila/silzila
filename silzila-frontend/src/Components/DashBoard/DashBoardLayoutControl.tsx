    ...
    return (
      <div style={{ margin: "10px", padding: "0px 5px 5px 16px" }}>
        ...
        {tabState.tabs[tabTileProps.selectedTabId].dashLayout
          .selectedOptionForAuto === "Aspect Ratio" ? (
          <div
            style={{
              display: "flex",
              columnGap: "20px",
...
const mapDispatchToProps = (dispatch: Dispatch<any>) => {
  return {
    setDashLayout: (tabId: number, value: any) =>
      dispatch(setDashLayout(tabId, value)),
    ...
    setCustomHeight: (tabId: number, value: any) =>
      dispatch(setCustomHeight(tabId, value)),
    setCustomWidth: (tabId: number, value: any) =>
      dispatch(setCustomWidth(tabId, value)),
