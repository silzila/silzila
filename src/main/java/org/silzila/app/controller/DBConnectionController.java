...
public class DBConnectionController {
    ...
    private static Connection connectViaDS() throws Exception {
        ...
        String URL = "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=stable-course-380911;OAuthType=0;OAuthServiceAcctEmail=svc-balu@stable-course-380911.iam.gserviceaccount.com;";
    ...
    public ResponseEntity<?> testBigQuery()
        ...
        ResultSet rs = st.executeQuery("select * FROM `stable-course-380911`.landmark.store;");
        // while (rs.next()) {
