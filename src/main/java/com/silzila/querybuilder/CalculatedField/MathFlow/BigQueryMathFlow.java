...
public class BigQueryMathFlow {
    ...
    public static void bigQueryMathFlow(DataSchema dataschema, Flow flow,
        ...
        if (basicMathOperations.containsKey(flowType)) {
            ...
            CalculatedFieldProcessedSource
                                .processAggregation("postgresql",dataschema,flow,"", sourceType.get(0), source.get(0), fields, flowStringMap, flowKey,  false,calculatedFieldMap);
        }
    }
    ...
    private static void processMathBasicOperations(DataSchema dataschema, Flow flow, Map<String, Field> fields,
        ...
        if (flow.getIsAggregation()) {
            mathematicalExpression = CalculatedFieldProcessedSource
                    .processAggregation(vendor, dataschema, flow, mathematicalExpression, "agg", null, fields,
    ...
    String mathematicalExpression = basicMathOperations.get(flow.getFlow()) + "(" + String.join(" ", result) + ")";
...
private static void processPowerOperation(Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
    ...
    String powerExpression = "POW(" + processedSource + ", " + source.get(1) + ")";
...
private static void processLogOperation(Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
                                         String flowKey, List<String> source, List<String> sourceType,  
                                         Map<String, CalculatedFieldDTO> calculatedFieldMap) throws BadRequestException {
    String processedValue = CalculatedFieldProcessedSource.getMathProcessedSource(source.get(0), sourceType.get(0), fields, flowStringMap, flow, 0, flowKey, calculatedFieldMap);
    ...
    String logExpression = "LOG(" + processedBase + ", " + processedValue + ")";
