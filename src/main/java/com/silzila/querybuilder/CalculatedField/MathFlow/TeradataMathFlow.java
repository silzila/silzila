...
public class TeradataMathFlow {
    ...
    public static void teraDataMathFlow(DataSchema dataschema, Flow flow,
    ...
    private static void processMathBasicOperations(
            DataSchema dataschema, Flow flow, Map<String, Field> fields,
    ...
    private static void processMultipleArgumentOperations(
            Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
            String flowKey, List<String> result, List<String> source,
        ...
        flowStringMap.put(flowKey, new FlowDTO(
                basicMathOperations.get(flow.getFlow()) + "(" + String.join(" ", result) + ")",
                "integer",
    ...
    private static void processLogOperation(Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
        ...
        result.append("LOG(").append(processedSource).append(")/LOG(").append(processedBase).append(")");
        flowStringMap.put(flowKey,
