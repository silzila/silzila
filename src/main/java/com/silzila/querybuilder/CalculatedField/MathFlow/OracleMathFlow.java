...
public class OracleMathFlow {
    ...
    public static void oracleMathFlow(DataSchema dataschema,Flow flow,
    ...
    if (basicMathOperations.containsKey(flowType)) {
        ...
        CalculatedFieldProcessedSource.processAggregation(vendor,dataschema,flow,"", sourceType.get(0), source.get(0), fields, flowStringMap, flowKey, false,calculatedFieldMap);
    }
}
