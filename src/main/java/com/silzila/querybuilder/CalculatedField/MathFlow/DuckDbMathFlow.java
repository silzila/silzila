...
public class DuckDbMathFlow {
    
    private final static String vendor = "duckdb";
    ...
    public static void duckDbMathFlow(DataSchema dataschema,Flow flow,
    ...
    private static void processMathBasicOperations(DataSchema dataschema,Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
        ...
        if(flow.getIsAggregation()){
            mathematicalExpression = CalculatedFieldProcessedSource
                                                    .processAggregation(vendor,dataschema,flow, mathematicalExpression, "agg", null, fields, flowStringMap, flowKey,  true,calculatedFieldMap);
        }
    }
    ...
    private static void processLogOperation(Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
        ...
        flowStringMap.put(flowKey, new FlowDTO(basicMathOperations.get(flow.getFlow()) + "(" + processedBase + "," + processedSource + ")","integer",flow.getIsAggregation()));
    }
}
