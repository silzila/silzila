...
public class SnowflakeMathFlow {
    ...
    public static void snowflakeMathFlow(DataSchema dataschema,Flow flow,
    ...
    private static void processMathBasicOperations(DataSchema dataschema,Flow flow, Map<String, Field> fields, Map<String, FlowDTO> flowStringMap,
        ...
        if(flow.getIsAggregation()){
            mathematicalExpression = CalculatedFieldProcessedSource
                                                    .processAggregation("snowflake",dataschema,flow, mathematicalExpression, "agg", null, fields, flowStringMap, flowKey,  true,calculatedFieldMap);
        }
    }
