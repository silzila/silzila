...
public class AdminControllerV1 extends BaseController {
   ...
   * endpoints. You can use the built-in SPEL expressions
   * in @PreAuthorize such as 'hasRole()' to determine if a user has access.
   * However, if you require logic beyond the methods
   * Spring provides then you can encapsulate it in a service and register it as a
   * bean to use it within the annotation as
