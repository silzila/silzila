...
public class PlayBookController {
    ...
    public ResponseEntity<?> createPlayBook(@RequestHeader Map<String, String> reqHeader,
            @RequestBody @Valid PlayBookRequest playBookRequest, @RequestParam String workspaceId) throws JsonProcessingException, BadRequestException {
    ...
    // list Playbooks
    @GetMapping("/playbook")
    public List<PlayBookMetaDTO> getAllPlaybook(@RequestHeader Map<String, String> reqHeader, @RequestParam String workspaceId)
            throws JsonProcessingException,BadRequestException {
        // get the requester user Id
        String userId = reqHeader.get("username");
        List<PlayBookMetaDTO> dtos = playBookService.getAllPlayBooks(userId,workspaceId);
        return dtos;
    }
    ...
    public ResponseEntity<?> updatePlayBook(@RequestHeader Map<String, String> reqHeader,
            @Valid @RequestBody PlayBookRequest playBookRequest, @PathVariable(value = "id") String id,   @RequestParam String workspaceId)
            throws JsonProcessingException, JsonMappingException, BadRequestException, RecordNotFoundException {
        // get the rquester user id
        String userId = reqHeader.get("username");
        PlayBook playBook = playBookService.updatePlayBook(playBookRequest, id, userId,workspaceId);
        return ResponseEntity.ok(playBook);
    ...
    public ResponseEntity<?> deletePlayBookById(@RequestHeader Map<String, String> reqHeader,
        ...
        playBookService.deletePlayBook(id, userId,workspaceId);
